...
const ships = [
    ...
    { id: 'spectre', name: 'Spectre', sprite: [[0,6,0],[6,2,6],[6,2,6],[0,6,0]], color: '#ffff33', stats: {hp: 110, speed: 5, damage: 11}, slots: {weapon: 2, shield: 2, engine: 1} },
    { id: 'phantom', name: 'Phantom', sprite: [[0,7,0],[7,2,7],[7,2,7],[0,7,0]], color: '#00ff99', stats: {hp: 105, speed: 5, damage: 10}, slots: {weapon: 2, shield: 1, engine: 2} },
    { id: 'nova', name: 'Nova', sprite: [[0,8,0],[8,2,8],[8,2,8],[0,8,0]], color: '#ff3333', stats: {hp: 120, speed: 4, damage: 12}, slots: {weapon: 2, shield: 1, engine: 1} },
    { id: 'blaze', name: 'Blaze', sprite: [[0,9,0],[9,2,9],[9,2,9],[0,9,0]], color: '#ff4444', stats: {hp: 95, speed: 6, damage: 9}, slots: {weapon: 1, shield: 1, engine: 2} },
    { id: 'comet', name: 'Comet', sprite: [[0,10,0],[10,2,10],[10,2,10],[0,10,0]], color: '#00ffff', stats: {hp: 80, speed: 7, damage: 8}, slots: {weapon: 1, shield: 1, engine: 2} },
    { id: 'vortex', name: 'Vortex', sprite: [[0,11,0],[11,2,11],[11,2,11],[0,11,0]], color: '#33ff33', stats: {hp: 90, speed: 6, damage: 9}, slots: {weapon: 1, shield: 1, engine: 1} },
    { id: 'delta', name: 'Delta', sprite: [[0,3,0],[3,2,3],[3,2,3],[0,3,0]], color: '#00bfff', stats: {hp: 100, speed: 5, damage: 10}, slots: {weapon: 1, shield: 1, engine: 1} },
];
...
const weapons = [
    { id: 'laser-omega', name: 'Láser Omega', color: '#ff0000', stats: {damage: 10, fireRate: 'media'}, price: 1500 },
    { id: 'laser-gamma', name: 'Láser Gamma', color: '#ff6600', stats: {damage: 8, fireRate: 'alta'}, price: 1200 },
    { id: 'laser-beta', name: 'Láser Beta', color: '#00bfff', stats: {damage: 6, fireRate: 'muy alta'}, price: 900 },
    { id: 'laser-alpha', name: 'Láser Alpha', color: '#00ff00', stats: {damage: 4, fireRate: 'muy alta'}, price: 600 },
];
