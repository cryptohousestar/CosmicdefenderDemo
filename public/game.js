...
class CosmicDefender {
    ...
    registerAllGameWidgets() {
        ...
        this.registerWidget('performancePanel', '#performancePanel', { x: window.innerWidth - 200, y: 10 }, 'Panel de Rendimiento');
    ...
    createMinimapContainer() {
        ...
        this.registerWidget('minimapContainer', '#minimapContainer', { x: 100, y: 100 }, 'Minimapa', true);
    }
    ...
    loadWidgetPositions() {
        ...
        this.widgets.forEach(widget => {
            ...
            if (!useDefault && positions[widget.type] && typeof positions[widget.type].visible !== 'undefined') {
                ...
                if (widget.type === 'widgetControlPanel' || widget.type === 'widgetInstructions') {
                    widget.element.style.display = 'none';
                }
                if (widget.type === 'widgetConfigButton' || ['playerStats','minimapContainer','notifications'].includes(widget.type)) {
    ...
    setupDefaultWidgets() {
        ...
        const defaultWidgets = ['widgetConfigButton', 'playerStats', 'skillsWidget'];
        this.widgets.forEach(widget => {
    ...
    updatePerformanceUI() {
        ...
        if (!performancePanel) {
            ...
            // Agregar al sistema de widgets
            this.addWidget(performancePanel, 'performancePanel', { x: window.innerWidth - 200, y: 10 }, 'Panel de Rendimiento');
        }
